...
const I18n = (function () {
    ...
    EMBEDDED['zh'] = {
        ...
        "form": {"name":"姓名 *","email":"邮箱 *","phone":"电话","company":"公司名称","productInterest":"产品意向","selectProduct":"请选择产品","message":"留言内容 *","submit":"发送询盘","success":"✓ 即将打开邮件客户端发送询盘。如未打开，请直接发邮件至 ateliertrim@yeah.net","error":"✗ 请填写所有必填项（姓名、邮箱、留言）。"},
    ...
    EMBEDDED['en'] = {
        ...
        "form":{"name":"Name *","email":"Email *","phone":"Phone","company":"Company","productInterest":"Product Interest","selectProduct":"Select a product","message":"Message *","submit":"Send Inquiry","success":"✓ Opening your email client to send inquiry. If not, please email us directly at ateliertrim@yeah.net","error":"✗ Please fill in all required fields (Name, Email, Message)."},
